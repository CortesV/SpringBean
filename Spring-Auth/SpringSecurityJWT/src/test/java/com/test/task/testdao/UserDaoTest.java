...
public class UserDaoTest {
	...
	public void getUserByUserName() {
		...
		Assert.assertEquals(userDao.findByUsername(username).getUserName(), user.getUserName());
	...
	public void getUsersTest() {
		...
		Assert.assertEquals(userDao.getUsers().size(), users.size());
	...
	public void getUserByIdTest() {
		...
		Assert.assertEquals(userDao.getUserById(1).getUserName(), user.getUserName());
