package com.devcortes.first_client_layer.grpc;
...
@GRpcService
public class FirstLayerGrpcReservationService extends GrpcReservationServiceGrpc.GrpcReservationServiceImplBase {

    private static final Logger LOGGER = LoggerFactory.getLogger(FirstLayerGrpcReservationService.class);
